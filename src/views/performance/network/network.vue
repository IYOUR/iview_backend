...
<div>
	...
	<div class="layout-content-tablePie">
		<Row :gutter="16">
			<Col span="12">
				<p>下发响应时常分布</p>
				<response-time-pie></response-time-pie>
			</Col>
			<Col span="12">
				<p>下发失败重试成功次数分布</p>
				<retry-times-pie></retry-times-pie>
			</Col>
		</Row>	
	</div>
	<div class="divisionLine"></div>	
	...
	watch:{
		'queryParam':{
			...
			handler:function(newVal,oldVal){
				...
				this.$store.dispatch('getNetworkResult',toDay);
				this.$store.dispatch('getNetworkResult',pastWeek);
			},
		}
	},
	computed: {
